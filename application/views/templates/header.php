...
<head>
	...
	<link rel="stylesheet" href="<?=base_url('assets/vendors/@fortawesome/fontawesome-free/css/all.min.css')?>">
	<link rel="stylesheet" href="<?= base_url('assets/vendors/ionicons-npm/css/ionicons.css')?>">
	<link rel="stylesheet" href="<?=base_url('assets/vendors/linearicons-master/dist/web-font/style.css')?>">
	<link rel="stylesheet"
		href="<?= base_url('assets/vendors/pixeden-stroke-7-icon-master/pe-icon-7-stroke/dist/pe-icon-7-stroke.css')?>">
	<link href="<?= base_url('assets/styles/css/base.css')?>" rel="stylesheet">
</head>
			...
			<div class="app-header__content">
													...
													<ul class="nav flex-column">
														...
														<li class="nav-item">
															<a href="javascript:void(0);" class="nav-link">
																...
																<span> Incidents</span>
																<div class="ms-auto badge rounded-pill bg-danger">5
																</div>
															</a>
														</li>
														<li class="nav-item">
								...
								<div class="dropdown-menu-header">
									<div class="dropdown-menu-header-inner bg-secondary">
										<div class="menu-header-image opacity-5"
											style="background-image: url('images/dropdown-header/abstract2.jpg');">
										</div>
								...
								<div class="dropdown-menu-header">
									<div class="dropdown-menu-header-inner bg-success">
										<div class="menu-header-image opacity-1"
											style="background-image: url('images/dropdown-header/abstract3.jpg');">
										</div>
				...
				<div class="app-header-right">
					<div class="header-dots">
						...
						<div class="dropdown">
							...
							<div tabindex="-1" role="menu" aria-hidden="true"
								...
								<ul
									...
									<li class="nav-item">
										<a role="tab" class="nav-link active" data-bs-toggle="tab"
													...
													<div
														...
														<div class="vertical-timeline-item vertical-timeline-element">
															<div>
																<span class="vertical-timeline-element-icon bounce-in">
																	<i
																		class="badge badge-dot badge-dot-xl bg-success"></i>
																</span>
																<div
																	class="vertical-timeline-element-content bounce-in">
														...
														<div class="vertical-timeline-item vertical-timeline-element">
															<div>
																<span class="vertical-timeline-element-icon bounce-in">
																	<i
																		class="badge badge-dot badge-dot-xl bg-warning"></i>
																</span>
																<div
																	class="vertical-timeline-element-content bounce-in">
														...
														<div class="vertical-timeline-item vertical-timeline-element">
															<div>
																<span class="vertical-timeline-element-icon bounce-in">
																	<i
																		class="badge badge-dot badge-dot-xl bg-danger"></i>
																</span>
																<div
																	class="vertical-timeline-element-content bounce-in">
														...
														<div class="vertical-timeline-item vertical-timeline-element">
															<div>
																<span class="vertical-timeline-element-icon bounce-in">
																	<i
																		class="badge badge-dot badge-dot-xl bg-primary"></i>
																</span>
																<div
																	class="vertical-timeline-element-content bounce-in">
						...
						<div class="dropdown">
							<button type="button" aria-haspopup="true" data-bs-toggle="dropdown"
								data-bs-placement="bottom" title="Tooltip on bottom" aria-expanded="false"
									...
									<div class="btn-group">
										...
										<div tabindex="-1" role="menu" aria-hidden="true"
											...
											<ul class="nav flex-column">
												<li class="nav-item-divider nav-item"></li>
												<li class="nav-item-btn text-center nav-item">
													<button class="btn-wide btn btn-primary btn-sm"> Open
														Messages</button>
												</li>
											</ul>
										</div>
					...
					<div class="app-footer__inner">
						<div class="app-footer-left">
							<div class="footer-dots">
								<div class="dropdown">
									<a aria-haspopup="true" aria-expanded="false" data-bs-toggle="dropdown"
										class="dot-btn-wrapper">
										<i class="dot-btn-icon lnr-bullhorn icon-gradient bg-mean-fruit"></i>
										<div class="badge badge-dot badge-abs badge-dot-sm bg-danger">Notifications
										</div>
									</a>
									<div tabindex="-1" role="menu" aria-hidden="true"
										...
										<ul
											...
											<li class="nav-item">
												<a role="tab" class="nav-link" data-bs-toggle="tab"
								...
								<div class="dropdown">
									<a class="dot-btn-wrapper dd-chart-btn-2" aria-haspopup="true"
										...
										<div class="badge badge-dot badge-abs badge-dot-sm bg-warning">Notifications
										</div>
									</a>
									<div tabindex="-1" role="menu" aria-hidden="true"
										class="dropdown-menu-xl rm-pointers dropdown-menu">
